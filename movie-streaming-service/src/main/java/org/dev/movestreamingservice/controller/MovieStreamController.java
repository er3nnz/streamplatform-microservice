package org.dev.movestreamingservice.controller;

import org.dev.movestreamingservice.service.MovieCatalogService;
...
public class MovieStreamController {
    ...
    public static final String VIDEO_PATH = "C:\\Users\\user\\Desktop\\";
    ...
    public ResponseEntity<InputStreamResource> streamVideoById(@PathVariable Long videoInfoId) throws FileNotFoundException {
        ...
        log.log(Level.INFO, "Movie path: " + moviePath);
